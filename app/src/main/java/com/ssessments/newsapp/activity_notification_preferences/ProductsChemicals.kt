...
import com.ssessments.newsapp.utilities.Chemicals
...
class ProductsChemicals: PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.products_chemicals, rootKey)
    ...
    override fun onStop() {
        super.onStop()
        activityViewModel.setChemicalsSummaryFromFragment(convertStringWithCommasToRealArray(enumValues<Chemicals>().joinToString {it.value}))
