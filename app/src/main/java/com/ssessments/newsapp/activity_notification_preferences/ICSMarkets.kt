...
class ICSMarkets: PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.markets_ics, rootKey)
    ...
    override fun onStop() {
        super.onStop()
        activityViewModel.setICSSummaryFromFragment(convertStringWithCommasToRealArray(enumValues<ICSMarkets>().joinToString {it.value}))
    }
}