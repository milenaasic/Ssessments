...
class AmericasMarkets: PreferenceFragmentCompat(), Preference.OnPreferenceChangeListener {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        setPreferencesFromResource(R.xml.markets_americas, rootKey)
    ...
    override fun onStop() {
        super.onStop()
        activityViewModel.setAmericasSummaryFromFragment(convertStringWithCommasToRealArray(enumValues<AmericasMarkets>().joinToString {it.value}))
    }
}